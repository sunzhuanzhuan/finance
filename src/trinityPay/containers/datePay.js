...
import { datePaySearch } from '../constants/search'
	...
	render() {
		...
		return <div className='datePay-container'>
			...
			<fieldset className='fieldset_css'>
				<legend>查询</legend>
				<SearForm data={datePaySearch} getAction={this.queryData} responseLayout={{ xs: 24, sm: 24, md: 10, lg: 8, xxl: 6 }} extraFooter={<Button type='primary' style={{ marginLeft: 20 }}>导出</Button>}/>
			</fieldset>
