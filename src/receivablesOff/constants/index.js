...
export const getOffQueryItems = queryArr => {
    const allQuery =  [
        ...
        {label: '发票申请单ID', key: 'invoice_application_id', compType: 'input', placeholder: '支持批量查询，以空格隔开'},
        {label: '订单ID', key: 'order_ids', compType: 'input', placeholder: '支持批量查询，以空格隔开'},
        {label: '活动ID', upperKey: 'order_id_active', key: 'order_ids', compType: 'input', placeholder: '支持批量查询，以空格隔开'},
